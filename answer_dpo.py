...
def get_answers(
    ...
    cot_prompt_template = prompts["cot"]
    ...
    for dataset in datasets:
        ...
        for idx, json_objs in enumerate(tqdm(data_batchs)):
            ...
            cot_prompts = [cot_prompt_template + json_obj["input"] for json_obj in json_objs]
            ...
            for i in range(len(outputs)):
                ...
                responses = [outputs[i].outputs[n].text for n in range(answer_n)]
